  ...
  return (
    <div className="home">
      ...
      <section className="team-info">
        ...
        <p>
          Join us in our pursuit of excellence both in and out of the pool. Our
          team combines competitive swimming with the college experience,
            ...
            <div key={index} className="timeline-item">
              <div className="timeline-content">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="president-linkedin-button"
                >
